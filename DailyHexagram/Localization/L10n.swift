...
enum L10n {
    private static let table: [String: (zh: String, en: String)] = [
        ...
        "recast_confirm_msg": ("《易》曰：初筮告，再三渎，渎则不告。当前卦象将被替换，每天仅此一次，慎之。", "The Yi warns: the first casting answers, but asking again and again clouds the oracle. This replaces today's reading — once per day, use it with care."),
        "confirm":         ("确定", "Confirm"),
        "cancel":          ("取消", "Cancel"),
        ...
        "wish_placeholder": ("写下你的心愿…（可留空，心诚即可）", "Write your wish… (optional)"),
        ...
        // 起卦仪式
        "start_cast":        ("开始起卦", "Begin Casting"),
        "quick_cast":        ("快速起卦（跳过仪式）", "Quick cast (skip ritual)"),
        "ritual_skip":       ("跳过", "Skip"),
        "ritual_breathe":    ("随圆环，缓缓呼吸", "Breathe slowly with the circle"),
        "ritual_focus_hint": ("闭目片刻，将所问之事默念三遍", "Close your eyes and repeat your question inwardly, three times"),
        "ritual_tap_continue": ("轻点屏幕继续", "Tap to continue"),
        "ritual_seal_hint":  ("不诚不占——以诚心相问者，长按此印", "Sincerity seals the asking — press and hold the seal"),
        "ritual_sealed":     ("心诚则灵", "Sincerity reaches far"),
        "ritual_setting":    ("起卦仪式", "Casting Ritual"),
        "greeting_morning":  ("晨起一卦，一日之计", "A morning casting sets the day"),
        "greeting_noon":     ("午后静心，观象自省", "An afternoon pause, a mirror for the mind"),
        "greeting_night":    ("夜阑人静，正宜观心", "In the quiet of night, look inward"),
        "incense_pray":      ("双手合十，默念所求之事", "Palms together — hold your prayer in silence"),
        "blessing_breath":   ("闭目静息，心愿自达", "A quiet breath carries the wish"),
        // Sound & shake
